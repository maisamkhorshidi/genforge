...
from .gp_config_utils_regress import resolve_regressor_config
...
def gp_config(gp):
    ...
    if cfg is None:
        ...
        cfg = RegressorConfig.from_legacy(legacy)

    config, userdata, diags = resolve_regressor_config(gp, cfg, return_diagnostics=True)
